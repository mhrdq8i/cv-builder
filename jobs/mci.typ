...
#u.experience(
  ...
  responsibilities: (
    ...
    "Writing a manifest to scale Oracle databases in production, for [My/Shop] MCI.",
    "Writing an Async 'Incident Management System' by FastAPI and Angular-20 based on Google SRE best practices. \n\n",
  ),
)
